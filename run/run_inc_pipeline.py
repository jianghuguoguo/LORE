...
_STAGES: List[Tuple[str, str, str, str]] = [
    (
        "layer0",
        "Layer 0  日志标准化",
        "python run/run_layer0.py --log-dir logs/新增 --output-dir new_data/layer0_output",
        "new_data/layer0_output",
    ),
    (
        "layer1",
        "Layer 1  LLM 会话标注",
        "python run/run_layer1_llm_batch.py --input-dir new_data/layer0_output --output-dir new_data/layer1_output",
        "new_data/layer1_output",
    ),
    (
        "layer2",
        "Layer 2  经验蒸馏",
        "python run/run_layer2_analysis.py --input-dir new_data/layer1_output --output-dir new_data/layer2_output --no-ragflow",
        "new_data/layer2_output",
    ),
    (
        "layer3_p12",
        "Layer 3  Phase 1+2  SEC / EWC",
        "python run/run_layer3_phase12.py --input-file new_data/layer2_output/experience_raw.jsonl --output-file new_data/layer3_output/phase12_result.jsonl",
        "new_data/layer3_output/phase12_result.jsonl",
    ),
    (
        "layer3_p34",
        "Layer 3  Phase 3+4  RME / BCC",
        "python run/run_layer3_phase34.py --input-file new_data/layer2_output/experience_raw.jsonl --output-file new_data/layer3_output/phase34_consolidated.jsonl",
        "new_data/layer3_output/phase34_consolidated.jsonl",
    ),
    (
        "layer3_p5",
        "Layer 3  Phase 5    KLM",
        "python run/run_layer3_phase5.py --consolidated-file new_data/layer3_output/phase34_consolidated.jsonl --raw-file new_data/layer2_output/experience_raw.jsonl --reflux-file new_data/layer3_output/phase5_reflux_ready.jsonl",
        "new_data/layer3_output/phase5_klm_registry.jsonl",
    ),
    (
        "layer4",
        "Layer 4  缺口感知 + 冲突检测",
        "python run/run_layer4_gap_dispatch.py --no-crawl",
        "new_data/layer4_output/gap_dispatch_summary.json",
    ),
    (
        "upload",
        "Upload   上传 Layer3 融合经验到 RAGflow",
        "python -m src.ragflow.uploader --source fused --fused-file new_data/layer3_output/phase34_consolidated.jsonl",
        "new_data/layer3_output/phase34_consolidated.jsonl",
    ),
]
